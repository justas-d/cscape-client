...
public final class ItemDef
{
	...
	public static void unpackConfig(StreamLoader streamLoader)
	{
		...
		try
		{
			PrintWriter pw = new PrintWriter(new FileWriter("itemlist.txt"));
			pw.println("{");

			for(int ii = 0; ii < totalItems; ii++)
			{
				ItemDef item = forID(ii);

				pw.println("\"" + item.id + "\": {");

				pw.println("\"aByte154\": \"" + item.aByte154 + "\",");
				pw.println("\"value\": \"" + item.value + "\",");
				pw.println("\"id\": \"" + item.id + "\",");
				pw.println("\"membersObject\": \"" + item.membersObject + "\",");
				pw.println("\"anInt162\": \"" + item.anInt162 + "\",");
				pw.println("\"certTemplateID\": \"" + item.certTemplateID + "\",");
				pw.println("\"anInt164\": \"" + item.anInt164 + "\",");
				pw.println("\"anInt165\": \"" + item.anInt165 + "\",");
				pw.println("\"anInt166\": \"" + item.anInt166 + "\",");
				pw.println("\"anInt167\": \"" + item.anInt167 + "\",");
				pw.println("\"modelOffset1\": \"" + item.modelOffset1 + "\",");
				pw.println("\"name\": \"" + item.name + "\",");
				pw.println("\"anInt173\": \"" + item.anInt173 + "\",");
				pw.println("\"modelID\": \"" + item.modelID + "\",");
				pw.println("\"anInt175\": \"" + item.anInt175 + "\",");
				pw.println("\"stackable\": \"" + item.stackable + "\",");
				pw.println("\"certID\": \"" + item.certID + "\",");
				pw.println("\"modelZoom\": \"" + item.modelZoom + "\",");
				pw.println("\"anInt184\": \"" + item.anInt184 + "\",");
				pw.println("\"anInt185\": \"" + item.anInt185 + "\",");
				pw.println("\"anInt188\": \"" + item.anInt188 + "\",");
				pw.println("\"modelRotation1\": \"" + item.modelRotation1 + "\",");
				pw.println("\"anInt191\": \"" + item.anInt191 + "\",");
				pw.println("\"anInt192\": \"" + item.anInt192 + "\",");
				pw.println("\"modelOffset2\": \"" + item.modelOffset2 + "\",");
				pw.println("\"anInt196\": \"" + item.anInt196 + "\",");
				pw.println("\"anInt197\": \"" + item.anInt197 + "\",");
				pw.println("\"modelRotation2\": \"" + item.modelRotation2 + "\",");
				pw.println("\"anInt200\": \"" + item.anInt200 + "\",");
				pw.println("\"anInt204\": \"" + item.anInt204 + "\",");
				pw.println("\"aByte205\": \"" + item.aByte205 + "\",");

				// java is fucking retarded
				jsonArrayInt("modifiedModelColors", item.modifiedModelColors, pw, false);
				jsonArrayInt("originalModelColors", item.originalModelColors, pw, false);

				jsonArrayStr("groundActions", item.groundActions, pw);
				jsonArrayByte("description", item.description, pw);
				jsonArrayStr("actions", item.actions, pw);
				jsonArrayInt("stackIDs", item.stackIDs, pw, false);
				jsonArrayInt("stackAmounts", item.stackAmounts, pw, true);
...
*/
	...
	//smh
	private static void jsonArrayInt(String name, int[] arr, PrintWriter pw, Boolean last) {
	...
	private static void jsonArrayStr(String name, String[] arr, PrintWriter pw)
	{
	...
	private static void jsonArrayByte(String name, byte[] arr, PrintWriter pw)
	{
